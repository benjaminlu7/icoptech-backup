...
add_action( 'after_setup_theme', function() {
		...
		/**
		 * By add_image_size( 'icoptech-small-thumbnails', 324, 324, true );. This should be used for content in the home for blogs.
		 */
		add_image_size( 'icoptech-small-thumbnails', 324, 324, true );

		/**
		 * By add_image_size( 'icoptech-medium-thumbnails', 810, 396, true );. This should be used for content that has sidebars.
		 */
		add_image_size( 'icoptech-medium-thumbnails', 810, 396, true );

		/**
		 * By add_image_size( 'icoptech-large-thumbnails', 1170, 614, true );. This should be used for content that has no sidebars.
		 */
		add_image_size( 'icoptech-large-thumbnails', 1170, 614, true );
		 ...
		 */
		load_theme_textdomain( 'icoptech', get_parent_theme_file_path( '/languages ' ) );
	}
);
		...
		register_default_headers(
			array(
				'header-image' => array(
					...
					'description'   => esc_html__( 'Header Image', 'icoptech' ),
				),
			)
		);
} );
